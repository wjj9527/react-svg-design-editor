...
//根据事件id修改事件属性
const SET_EVENT_ATTRIBUTE_BY_EVENT_ID = 'SET_EVENT_ATTRIBUTE_BY_EVENT_ID';
//变化样式设置
const SET_CHANGE_STYLE_BY_EVENT_ID = 'SET_CHANGE_STYLE_BY_EVENT_ID';
//canvasMoveStatus画布拖动状态
const SET_CANVAS_MOVE_STATUS = 'SET_CANVAS_MOVE_STATUS';
//设置缩放百分比
const SET_CANVAS_SCALE = 'SET_CANVAS_SCALE';
//设置设备列表
const SET_DEVICE_LIST = 'SET_DEVICE_LIST';
//设置设备列表请求状态
const SET_DEVICE_LIST_REQUEST_LOADING_STATUS =
  'SET_DEVICE_LIST_REQUEST_LOADING_STATUS';
export default {
  SET_CURRENT_ACTION,
  ...
  SET_EVENT_ATTRIBUTE_BY_EVENT_ID,
  SET_CHANGE_STYLE_BY_EVENT_ID,
  SET_CANVAS_MOVE_STATUS,
  SET_CANVAS_SCALE,
  SET_DEVICE_LIST,
  SET_DEVICE_LIST_REQUEST_LOADING_STATUS,
};
